...
export caskList=(
  ...
  "google-backup-and-sync::Google Drive: Backup and Sync is an app for Mac and PC that backs up files and photos safely in Google Drive and Google Photos, so they're no longer trapped on your computer and other devices https://www.google.co.uk/drive/download/"
  "authy::Two-factor authentication 2FA adds an additional layer of protection beyond passwords https://authy.com/"
  ...
  "docker-compose::Compose is a tool for defining and running multi-container Docker applications https://docs.docker.com/compose/"
	"github-desktop::Extend your GitHub workflow beyond your browser with GitHub Desktop, completely ... Open your favorite editor or shell from the app, or jump back to GitHub https://desktop.github.com/"
  ...
  "gitscout::A beautiful and optimized GitHub Issues experience for macOS https://gitscout.com/"
	"dash3::Dash is an API Documentation Browser and Code Snippet Manager. ... Store snippets of code; Easily reuse snippets; Expand snippets in any app https://kapeli.com/dash"
  "now::Realtime Global Deployments https://zeit.co/now"
	"zeplin::Connected space for product teams. Handoff designs and styleguides with accurate specs, assets, code snippets—automatically https://zeplin.io/"
    ...
    "sublime-text::Sublime Text is a sophisticated text editor for code, markup and prose. You'll love the slick user interface, extraordinary features and amazing performance  https://www.sublimetext.com/"
  	"eclipse-java::Eclipse is famous for the Java Integrated Development Environment (IDE) https://www.eclipse.org/downloads/packages/"
...
## Productivity
  ...
  "station::Station unifies all your work tools in one neat & productive interface. ... One app to rule them all. Station is the first smart workstation for busy people https://getstation.com/"
  	...
  	"skype::Free online calls, messaging, affordable international calling to mobiles or landlines and Skype for Business for effective collaboration https://www.skype.com/en/"
		...
		"franz::Franz is your messaging app for WhatsApp, Facebook Messenger, Slack, HipChat, Telegram and many many more https://meetfranz.com/"
		...
		"mendeley::Mendeley is a free reference manager and an academic social network https://www.mendeley.com/"
  ...
  "hacker-menu::Hacker News Delivered to Desktop https://hackermenu.io/"
  
	## Utilities
  
	"caffeine::Caffeine is a tiny program that puts an icon in the right side of your menu bar. Click it to prevent your Mac from automatically going to sleep, dimming the screen http://lightheadsw.com/caffeine/"
  ...
  "kap-beta::An open-source screen recorder built with web technology https://getkap.co/"
	"muzzle::muzzle. a simple mac app to silence embarrassing notifications while screensharing https://muzzleapp.com/"
